...
Our lab studies how the brain generates and regulates emotion, how bioenergetic
health shapes high-demand brain systems, and how these processes contribute to
resilience, aging, and mental health. We use tools including fMRI, EEG,
computational modeling, machine learning, behavioral experiments, and
peripheral biomarkers.

We welcome people from diverse backgrounds, including psychology, neuroscience,
engineering and computer science, statistics, biology, and related fields.
Prior experience in all of these areas is not required. More important are
curiosity, reliability, openness to learning, and excitement about
interdisciplinary research.

## Who we are looking for

Good fits for the lab may be interested in one or more of the following areas:

- Affective neuroscience
- MRI, EEG, and multimodal brain imaging
- Mitochondrial function, fatigue, aging, and mental health
- Computational modeling and machine learning
- Intervention approaches, including neurofeedback, brain stimulation,
  exercise, sleep, or metabolic and lifestyle interventions

We especially value lab members who enjoy working across disciplines and are
excited to connect rigorous quantitative methods with meaningful questions
about human emotion and well-being.
...
- Your methodological interests or skills
- A CV or resume
